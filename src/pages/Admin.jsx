...
import {
  Shield, BookOpen, Users, Eye, Heart, Trash2, Check, X, Search
} from "lucide-react";
...
export default function Admin() {
  ...
  }, [isLoadingAuth, isAuthenticated, user, isAdmin, navigateToLogin]);
  ...
  if (isLoadingAuth || !user || !isAdmin) return null;

  const filteredStories = stories.filter(
    (s) =>
      !searchStory ||
      s.title?.toLowerCase().includes(searchStory.toLowerCase()) ||
                ...
                {filteredStories.map((story) => (
                  <TableRow key={story.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          story.is_approved ? "default" : "destructive"
                        }
                        className="text-xs"
                      >
